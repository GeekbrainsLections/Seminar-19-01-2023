...
Слияние веток проиходит с помощью команды *git merge и название ветки*  и слияние нужно длеать в той ветке куда планируете слить. 

## Удаление веток
Удаление веток происходит командой *git branch -d и название ветки*
