...
При создании новой ветки необходимо называть ее кратким и ёмким именем. Чтобы сразу было понятно, что именно изменялось по проекту. Переключаться между ветками можно такой командой: git checkout <название_ветки>. Перед тем как сливать новый merge, стоит обновить локальную ветку master, во избежания дальнейших проблем.

Команда merge берет все изменения из ветки и добавляет их в ветку master. Git старается автоматически сливать изменения, однако это не всегда возможно. Иногда возникают конфликты. Например, когда в двух ветках были изменения в одной и той же строчке кода. Если такое произошло, то необходимо разрешить конфликт вручную.
...
Удалённые репозитории – это версии вашего проекта, сохранённые в интернет пространстве. 
Для начала работы с внешним репозиторием на странице определенного автора необходимо нажать *fork* и далее *create fork*. После чего появится полная версия внешнего репозитория у вас на странице, например, на GH. 
Клонировать вешний репозиторий можно используя команду *gir clone ссылка, скопированная с GH*. И автоматически этот удалённый репозиторий появится у вас на компьютере. 

Выполнение команды *git pull* позволит скачать все из текущего репозитория, и автоматически слить (merge) их с кодом, над которым вы сейчас работаете.

После внесения необходимых дополнений в файл можно его отправить автору во внешний репозиторий, используя команду *git push*.